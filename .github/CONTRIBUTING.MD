...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/repo-slug/issues)
...
* For bug fixes, checkout the DEV branch of the Plugin Name repository.
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/repo-slug.git` to set the upstream repo
...
* For bug fixes, submit a pull request to the DEV branch of the Plugin Name repository.
